...
async def wait_for(page, selector = "", text = "", timeout = 10):
    ...
    except uc.core.connection.ProtocolException:
        item = None
...
async def run_diagnostics(browser: uc.Browser, quiet = True):
    """
...
async def get_fingerprint_score(browser: uc.Browser, quiet = False):
    """
...
async def check_entropy(browser: uc.Browser, quiet = False):
    """
